...
@click.option('-d', '--domain-name', 
    help='Domain Name')
@click.option('-t', '--tenancy-name', 
    help='Tenancy Name')
...
def main(ctx: click.Context, base_uri: str, domain_name: str, tenancy_name: str, 
        username: Union[str, None], creds_filepath: str, 
    ...
    except AuthenticationError as auth_exec:
        log.exception('')
        raise SystemExit(str(auth_exec))
